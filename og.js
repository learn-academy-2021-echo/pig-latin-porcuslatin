  ...
  myPigLatinCodeHere = () => {
    ...
    let translatedWordsArray = userInput.map(currentWord => {
      ...
      console.log("currentWord:", currentWord)
       ...
       // if index[0] of currentWord is a vowel add "way" to the end of string
       // slice the current word from index[0] to the vowel
  ...
  render() {
    return (
      <>
        ...
        <footer>Coded by Hannah, Josh, and Gluay</footer>
      </>
    )
  }
}
